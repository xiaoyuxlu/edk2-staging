...
#ifndef _SMM_ACCESS2_PPI_H_
#define _SMM_ACCESS2_PPI_H_

#define EFI_PEI_SMM_ACCESS2_PPI_GUID \
  { 0xf096ba06, 0xafff, 0x4246, { 0xa2, 0x39, 0x7f, 0xc, 0xd7, 0xec, 0xa6, 0x36 }}

typedef struct _EFI_PEI_SMM_ACCESS2_PPI  EFI_PEI_SMM_ACCESS2_PPI;
...
/**
  ...
  @param  This                   The pointer to the EFI_PEI_SMM_ACCESS2_PPI Interface.
...
typedef
EFI_STATUS
(EFIAPI *EFI_PEI_SMM_OPEN2)(
  IN EFI_PEI_SMM_ACCESS2_PPI              *This
  );
...
typedef
EFI_STATUS
(EFIAPI *EFI_PEI_SMM_CAPABILITIES2)(
  IN EFI_PEI_SMM_ACCESS2_PPI              *This,
...
///  that the north bridge or memory controller would publish this PPI.
/// 
struct _EFI_PEI_SMM_ACCESS2_PPI {
  EFI_PEI_SMM_OPEN2          Open;
  EFI_PEI_SMM_CLOSE2         Close;
  EFI_PEI_SMM_LOCK2          Lock;
  EFI_PEI_SMM_CAPABILITIES2  GetCapabilities;
  BOOLEAN                    LockState;
  BOOLEAN                    OpenState;
};

extern EFI_GUID gEfiPeiSmmAccess2PpiGuid;
