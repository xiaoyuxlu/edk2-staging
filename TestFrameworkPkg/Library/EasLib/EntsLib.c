...
EFI_GUID                        gtEfiLoadFileProtocolGuid         = EFI_LOAD_FILE_PROTOCOL_GUID;
...
EFI_GUID                        gtEfiFileSystemInfoGuid             = EFI_FILE_SYSTEM_INFO_ID;
EFI_GUID                        gtEfiFileSystemVolumeLabelInfoGuid  = EFI_FILE_SYSTEM_VOLUME_LABEL_ID;
...
//
EFI_GUID                        gtEfiUnknownDeviceGuid = BLOCKIO_VENDOR_GUID;
...
EFI_GUID                        gtEfiSMBIOSTableGuid    = SMBIOS_TABLE_GUID;
EFI_GUID                        gtEfiSalSystemTableGuid = SAL_SYSTEM_TABLE_GUID;
