...
#define EFI_SCT_CONFIG_DATA_SIGNATURE       SIGNATURE_32('s','c','f','g')
...
#define BIOS_ID_DEFAULT                     L"UEFI 2.0"
...
#define EFI_SCT_CATEGORY_DATA_SIGNATURE     SIGNATURE_32('s','c','a','t')
...
#define EFI_SCT_TEST_CASE_SIGNATURE         SIGNATURE_32('s','t','c','s')
...
#define EFI_SCT_TEST_FILE_SIGNATURE         SIGNATURE_32('s','t','f','l')
...
#define EFI_SCT_TEST_NODE_SIGNATURE         SIGNATURE_32('s','t','n','d')
...
#define EFI_SCT_FRAMEWORK_TABLE_SIGNATURE   SIGNATURE_32('s','f','w','t')
...
typedef struct {
  ...
  LIST_ENTRY                      SupportFileList;
  LIST_ENTRY                      ProxyFileList;

  LIST_ENTRY                      TestCaseList;
  LIST_ENTRY                      TestNodeList;
...
#define MDK_LIBRARY_INSTANCE_SIGNATURE         SIGNATURE_32('m','d','k','l')
