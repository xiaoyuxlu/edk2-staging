...
//
#define EFI_NETWORK_TEST_FILE_SIGNATURE   SIGNATURE_32 ('n', 't', 'f', 'l')
...
#define EFI_MONITOR_COMMAND_SIGNATURE SIGNATURE_32 ('n', 's', 'c', 'd')
...
//
#define EFI_NETWORK_TEST_FRAMEWORK_TABLE_SIGNATURE  SIGNATURE_32 ('n', 'f', 'w', 't')
...
typedef struct _EFI_NETWORK_TEST_FRAMEWORK_TABLE {
  ...
  // Test data
  //
  LIST_ENTRY            TestAppList;

  //
  // Test support list
  //
  LIST_ENTRY            SupportList;
