...
--*/
{
  ...
  //
  if (ApTest->Name != NULL) {
    FreePool (ApTest->Name);
    ApTest->Name = NULL;
  }

  if (ApTest->Description != NULL) {
    FreePool (ApTest->Description);
