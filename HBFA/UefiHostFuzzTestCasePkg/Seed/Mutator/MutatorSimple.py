...
def GenerateCommand(Command, InputFile):
    ...
    CommandLine = Template.replace("<Command>", Command).replace("<InputFile>", InputFile)
    #print(CommandLine)
    return CommandLine
...
if __name__ == '__main__':
    ...
    parser.add_argument(metavar="input_file", dest='InputFile', type=argparse.FileType('rb'), help="specify the input file")
    parser.add_argument("--Offset", dest='Offset_Str', type=str, help="specify the offset of buffer to be mutated.")
    parser.add_argument("--Size", dest='Size_Str', type=str, help="specify the size of buffer to be mutated.")
    parser.add_argument("-e", "--exec", dest='Executable', type=str, metavar='filename', help="specify the executable filename", required=True)
    ...
    for Index in range (args.Offset, args.Offset + args.Size - 3) :
        ...
        args.InputBuffer[Index:Index+4] = [RandomData, RandomData2, RandomData3, RandomData4]
    ...
    for Index in range (args.Offset, args.Offset + args.Size - 7) :
        ...
        args.InputBuffer[Index:Index+8] = [RandomData, RandomData2, RandomData3, RandomData4, RandomData5, RandomData6, RandomData7, RandomData8]
