...
#define UNIT_TEST_NAME        L"SmmServices Unit Test"
...
int main()
{
  ...
  Status = CreateUnitTestSuite (&TestSuite, Fw, L"SmmServices Basic Test Suite", L"Common.SmmServices.Basic", NULL, NULL);
  if (EFI_ERROR(Status)) {
    DEBUG((DEBUG_ERROR, "Failed in CreateUnitTestSuite for SmmServices Basic Test Suite\n"));
    Status = EFI_OUT_OF_RESOURCES;
    goto EXIT;
  }

  AddTestCase(TestSuite, L"Test ProtocolDatabase", L"Common.SmmServices.Basic.ProtocolDatabase", TestProtocolDatabase, NULL, NULL, NULL);
