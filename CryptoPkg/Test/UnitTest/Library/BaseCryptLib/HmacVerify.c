...
typedef
UINTN
(EFIAPI *EFI_HMAC_GET_CONTEXT_SIZE) (
  VOID
  );
...
typedef struct {
  UINT32                     DigestSize;
  EFI_HMAC_GET_CONTEXT_SIZE  GetContextSize;
...
HMAC_TEST_CONTEXT       mHmacMd5TestCtx    = {MD5_DIGEST_SIZE,    HmacMd5GetContextSize,    HmacMd5Init,    HmacMd5Update,    HmacMd5Final,    HmacMd5Key,    sizeof(HmacMd5Key),    HmacMd5Digest};
HMAC_TEST_CONTEXT       mHmacSha1TestCtx   = {SHA1_DIGEST_SIZE,   HmacSha1GetContextSize,   HmacSha1Init,   HmacSha1Update,   HmacSha1Final,   HmacSha1Key,   sizeof(HmacSha1Key),   HmacSha1Digest};
HMAC_TEST_CONTEXT       mHmacSha256TestCtx = {SHA256_DIGEST_SIZE, HmacSha256GetContextSize, HmacSha256Init, HmacSha256Update, HmacSha256Final, HmacSha256Key, sizeof(HmacSha256Key), HmacSha256Digest};
  ...
  )
{
  ...
  CtxSize = HmacTestContext->GetContextSize ();
  HmacTestContext->HmacCtx = AllocatePool (CtxSize);
...
TEST_DESC mHmacTest[] = {
    ...
    //
    {L"TestVerifyHmacMd5()",    L"CryptoPkg.BaseCryptLib.Hmac",   TestVerifyHmac, TestVerifyHmacPreReq, TestVerifyHmacCleanUp, &mHmacMd5TestCtx},
    {L"TestVerifyHmacSha1()",   L"CryptoPkg.BaseCryptLib.Hmac",   TestVerifyHmac, TestVerifyHmacPreReq, TestVerifyHmacCleanUp, &mHmacSha1TestCtx},
    {L"TestVerifyHmacSha256()", L"CryptoPkg.BaseCryptLib.Hmac",   TestVerifyHmac, TestVerifyHmacPreReq, TestVerifyHmacCleanUp, &mHmacSha256TestCtx},
};
