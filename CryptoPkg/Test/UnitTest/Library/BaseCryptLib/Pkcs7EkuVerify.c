...
TEST_DESC mPkcs7EkuTest[] = {
    ...
    //
    {L"TestVerifyEKUsInSignature()",            L"CryptoPkg.BaseCryptLib.Eku",   TestVerifyEKUsInSignature,            NULL, NULL, NULL},
    {L"TestVerifyEKUsWith3CertsInSignature()",  L"CryptoPkg.BaseCryptLib.Eku",   TestVerifyEKUsWith3CertsInSignature,  NULL, NULL, NULL},
    {L"TestVerifyEKUsWith2CertsInSignature()",  L"CryptoPkg.BaseCryptLib.Eku",   TestVerifyEKUsWith2CertsInSignature,  NULL, NULL, NULL},
    {L"TestVerifyEKUsWith1CertInSignature()",   L"CryptoPkg.BaseCryptLib.Eku",   TestVerifyEKUsWith1CertInSignature,   NULL, NULL, NULL},
    {L"TestVerifyEKUsWithMultipleEKUsInCert()", L"CryptoPkg.BaseCryptLib.Eku",   TestVerifyEKUsWithMultipleEKUsInCert, NULL, NULL, NULL},
    {L"TestEkusNotPresentInSignature()",        L"CryptoPkg.BaseCryptLib.Eku",   TestEkusNotPresentInSignature,        NULL, NULL, NULL},
    {L"TestProductId10001PresentInSignature()", L"CryptoPkg.BaseCryptLib.Eku",   TestProductId10001PresentInSignature, NULL, NULL, NULL},
    {L"TestOnlyOneEkuInListRequired()",         L"CryptoPkg.BaseCryptLib.Eku",   TestOnlyOneEkuInListRequired,         NULL, NULL, NULL},
    {L"TestNoEKUsInSignature()",                L"CryptoPkg.BaseCryptLib.Eku",   TestNoEKUsInSignature,                NULL, NULL, NULL},
    {L"TestInvalidParameters()",                L"CryptoPkg.BaseCryptLib.Eku",   TestInvalidParameters,                NULL, NULL, NULL},
    {L"TestEKUSubsetSupersetFails()",           L"CryptoPkg.BaseCryptLib.Eku",   TestEKUSubsetSupersetFails,           NULL, NULL, NULL},
};
