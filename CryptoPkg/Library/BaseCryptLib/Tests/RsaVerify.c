...
TEST_DESC mRsaTest[] = {
    ...
    //
    {L"TestVerifyRsaSetGetKeyComponents()",       L"CryptoPkg.BaseCryptLib.Rsa",   TestVerifyRsaSetGetKeyComponents,       TestVerifyRsaPreReq, TestVerifyRsaCleanUp, NULL},
    {L"TestVerifyRsaGenerateKeyComponents()",     L"CryptoPkg.BaseCryptLib.Rsa",   TestVerifyRsaGenerateKeyComponents,     TestVerifyRsaPreReq, TestVerifyRsaCleanUp, NULL},
    {L"TestVerifyRsaPkcs1SignVerify()",           L"CryptoPkg.BaseCryptLib.Rsa",   TestVerifyRsaPkcs1SignVerify,           TestVerifyRsaPreReq, TestVerifyRsaCleanUp, NULL},
};
