...
TEST_DESC mRsaCertTest[] = {
    ...
    //
    {L"TestVerifyRsaCertPkcs1SignVerify()", L"CryptoPkg.BaseCryptLib.RsaCert", TestVerifyRsaCertPkcs1SignVerify, NULL, NULL, NULL},
};
...
TEST_DESC mPkcs7Test[] = {
    ...
    // -----Description--------------------------------------Class----------------------Function-----------------Pre---Post--Context
    //
    {L"TestVerifyPkcs7SignVerify()",        L"CryptoPkg.BaseCryptLib.Pkcs7",   TestVerifyPkcs7SignVerify,        NULL, NULL, NULL},
};
