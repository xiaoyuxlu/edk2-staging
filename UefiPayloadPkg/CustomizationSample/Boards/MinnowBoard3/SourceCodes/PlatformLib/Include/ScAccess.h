...
//
// to-do: PCIEX_BASE_ADDRESS is also defined in UefiPayload dsc
// Need a way to only derive from one source. E.g., let tool to translate the 
// user setting to both UEFI payload and to custom source codes (i.e., here)
//
...
//
#include "Include/ScRegs/RegsPcu.h"
#include "Include/ScRegs/RegsPmc.h"
#include "Include/ScRegs/RegsSpi.h"
#include "Include/ScRegs/RegsLpc.h"
#include "Include/ScRegs/RegsSata.h"
#include "Include/ScRegs/RegsUsb.h"
