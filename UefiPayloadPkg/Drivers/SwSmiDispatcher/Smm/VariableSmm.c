...
STATIC BOOLEAN                                       mVariableSmmAtRuntime = FALSE;
...
EDKII_SMM_VAR_CHECK_PROTOCOL mSmmVarCheck = { VarCheckLibRegisterSetVariableCheckHandler,
  ...
  )
{
  ...
  switch (SmmVariableFunctionHeader->Function) {
    ...
    case SMM_VARIABLE_FUNCTION_VAR_CHECK_VARIABLE_PROPERTY_GET:
      ...
      Status = VarCheckLibVariablePropertyGet (
                 CommVariableProperty->Name,
                 &CommVariableProperty->Guid,
                 &CommVariableProperty->VariableProperty
                 );
    ...
    default:
      DEBUG ((EFI_D_ERROR, "** Smm Var dispatch: unsupported\n"));
      Status = EFI_UNSUPPORTED;
  }
  ...
  )
{
  ...
  // Variable initialize.
  //
  Status = PlatformLibInitializeVariable ();
